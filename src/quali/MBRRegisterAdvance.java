...
public class MBRRegisterAdvance {
...
public static void registerRectangle(Rectangle rec,boolean edge)
{
	MBR mbr = new MBR(rec);
	if(edge)
		MBRRegisterAdvance.edge.add(mbr);
    		...
    		if(_contact.getTangential_area() == 34 || _contact.getTangential_area() == 3 || _contact.getTangential_area() == 4)
    		  {
    			 ...
    			 //  System.out.println("contact spcifics "+_contact.getTangential_area() +  "    " + region1Contact + "    " + region2Contact);
...
public static LinkedList<Contact> getContact(Configuration conf, Configuration tconf)
{
     ...
     if(conf.unary == 0 && tconf.unary == 0)
     {
    	  ...
    	  boolean tr14 = testRegularRegion14(conf,tconf);
    	 	//System.out.println(conf.getMbr() + "    " + tconf.getMbr()  + "   " + tr2 + "   " + tr1 + "   " + tr3 +  "   " + tr4 + "   " + tr23 + "   " + tr14);
          if( tr2 && tr1)
          {
    	  ...
    	  }else if( tr3)
          {
	    		  ...
	    		  _contact.setType(1);
	    		  contacts.add(_contact);
	    	//	System.out.println( "    tr3 clause  " + conf + "    " + tconf + "   " + tr3);
    	  }else if(tr4)
          {
    			  Contact _contact = new Contact();
